...
alias py="python3"
alias pip="pip3"
alias setup="mas lucky bear && mas lucky mindnode"
alias work="cd ~/code"
alias try_c="cp ~/icloud_portal/code/do_not_del/main_sample.c ./main_test.c && vi main_test.c"
export PATH=$HOME/.brew/bin:$PATH
export PATH=$HOME/bin:$PATH
git config --global user.name lobbyra
git config --global user.email jecaudal@student.42.fr
